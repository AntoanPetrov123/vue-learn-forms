<template>
    <div class="container">
        <form>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        ...
                        <!-- v-model.lazy react when we change event (click somewhere after typing) -->
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="form-group">
                        ...
                        <label for="sendInfomail">
                            <input type="checkbox" id="sendInfomail" value="SendInfoMail" v-model="sendMail"> Send
                            Infomail
                        </label>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
                    <!-- use the same v-model for radio buttons -->
                    <label for="male">
            ...
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- keep white space how we pass tehem in textarea -->
